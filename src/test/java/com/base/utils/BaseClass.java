...
//		}
		...
		public static void reportStatus(String status, String description) throws IOException {
			...
			case "fail screenshot":
				test.fail(description, MediaEntityBuilder.
						createScreenCaptureFromPath(addScreenshots()).build());
				break;
			default:
...
//		}
		...
		public static void browserOpen(String browser) {
			...
			case "firefox":
				System.setProperty("webdriver.gecko.driver", "C:\\Users\\Admin\\Oct(Selenium) & Dec(Project)\\PracticeSample\\Drivers\\geckodriver.exe");
